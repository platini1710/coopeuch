...
@Api(value = "ProductoDetalle microservice", description = "recupera datos de la  tabla ProductoDetalle")
public class ProductDetailRetrieveController {
	...
	/**
	   ...
	   */
	 @ApiOperation(value = "recupera  uno mas detalle de un id producto de acuerdo  al id del producto", notes = "Return clase Respuesta "
		 		+ " retorna el resultado en campo ListProductoDetalle,  si no existen registros manda el respectivo msg " ) 
	
	  @RequestMapping(method = RequestMethod.GET, value="/detalle")
	  public Respuesta getProductoDetalleById(@RequestParam(value = "id") Long id)
