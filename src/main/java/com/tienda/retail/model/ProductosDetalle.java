...
public class ProductosDetalle {
	...
	@ApiModelProperty(value = "clave PK compuesta  del detalle del producto , no es null", required = true)
    @EmbeddedId
    private ProductosDetalleId id;
	@ApiModelProperty(value = "codigo del producto detallle , no es null", required = true)
    @Column(name = "codigoproductodetalle", nullable = false)
    private String codigoProductoDetalle;
	@ApiModelProperty(value = "precio del producto , no es null", required = false)
    @Column(name = "precio", nullable = false)
    private Long precio;
	@ApiModelProperty(value = "stock del producto , no es null", required = false)
    @Column(name = "stock")
    private Long stock;
